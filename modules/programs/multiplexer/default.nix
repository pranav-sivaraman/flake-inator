{
  flake.aspects.shell = {
    homeManager = { pkgs, ... }: {
      programs.zellij = {
        enable = true;
        package = pkgs.zellij.overrideAttrs (oldAttrs: {
          patches = (oldAttrs.patches or [ ]) ++ [
            (pkgs.fetchpatch {
              url = "https://github.com/zellij-org/zellij/pull/4545.patch";
              hash = "sha256-u8+y1h+ENtCEvsek+tVncfbelP8typBRn9n9Hk7g6aM=";
            })
          ];
        });
        settings = {
